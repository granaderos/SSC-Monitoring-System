...
<html>
    ...
    <body>
        ...
        <div id="divMainContainer" class="container container-fluid">
            <div>
                <h6 class="alert alert-info text-center">SSC Officers</h6>
                <table style="margin: auto; font-size: 12px;" class="table table-bordered " id="tblWeeklyReport"></table>
            </div>
        </div>
